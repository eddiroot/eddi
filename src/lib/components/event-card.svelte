<script lang="ts">
	...
	let { event, eventType, subjectInfo, subjectColor, showTime = true }: EventCardProps = $props();
...
>
	...
	>
		<Card.Header class="p-1">
			...
			<div class="space-y-1">
				{#if showTime}
					<Card.Description class="flex items-center gap-1 text-xs text-ellipsis whitespace-nowrap">
