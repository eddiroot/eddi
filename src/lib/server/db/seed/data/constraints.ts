...
export const TIME_CONSTRAINTS: ConstraintDefinition[] = [
	{
		...
		description: 'Ensures all activities are scheduled within the defined time periods. This is a mandatory constraint.',
...
export const SPACE_CONSTRAINTS: ConstraintDefinition[] = [
	{
		...
		description: 'Ensures all activities are assigned to appropriate spaces. This is a mandatory constraint.',
