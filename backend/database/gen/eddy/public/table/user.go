...
func newUserTableImpl(schemaName, tableName, alias string) userTable {
	var (
		...
		MiddleNameColumn = postgres.StringColumn("middleName")
		LastNameColumn   = postgres.StringColumn("lastName")
		UsernameColumn   = postgres.StringColumn("username")
		PasswordColumn   = postgres.StringColumn("password")
		AvatarUrlColumn  = postgres.StringColumn("avatarUrl")
		CreatedAtColumn  = postgres.TimestampColumn("createdAt")
		ModifiedAtColumn = postgres.TimestampColumn("modifiedAt")
		allColumns       = postgres.ColumnList{IDColumn, FirstNameColumn, MiddleNameColumn, LastNameColumn, UsernameColumn, PasswordColumn, AvatarUrlColumn, CreatedAtColumn, ModifiedAtColumn}
		mutableColumns   = postgres.ColumnList{FirstNameColumn, MiddleNameColumn, LastNameColumn, UsernameColumn, PasswordColumn, AvatarUrlColumn, CreatedAtColumn, ModifiedAtColumn}
